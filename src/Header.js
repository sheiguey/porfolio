        ...
        <header id="home" className={classes.header}>
            <div className={classes.intro}>
                <div   className={`${classes.description}  fadeInUp  animate__animated`}>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=655604155"rel="noreferrer" target="_blank" className={classes.button} >Hire Me</a>
                    <a alt="my Resume" href="/assets/resume-FrankyShiti.pdf" target="_blank" className={classes.button}>My resume</a>
                </div>
